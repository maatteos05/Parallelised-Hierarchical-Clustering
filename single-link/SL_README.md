...
```sh
./hac_single_baseline ../data/input.csv ../results/dendrograms/single-link/baseline_output.csv
```

MST version:

```sh
./hac_single_mst ../data/input.csv ../results/dendrograms/single-link/mst_output.csv 4
```
