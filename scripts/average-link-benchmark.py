...
Outputs:
    data/benchmark_results.csv   — raw timing data
    data/benchmark_speedup.csv   — speedup relative to sequential baseline
...
RESULTS_CSV     = DATA_DIR  / "average_link_benchmark_results.csv"
SPEEDUP_CSV     = DATA_DIR  / "average_link_benchmark_speedup.csv"
...
def main():
    ...
    tmp_out = DATA_DIR / "average_link_bench_tmp.csv"
